...
public class Interfaz extends JFrame {
	...
	public Interfaz() {
		...
		lblValorDelLado.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		...
		lblValorDelLado_1.setFont(new Font("Segoe UI", Font.PLAIN, 20));
	...
	public void mostrarResultado() {
		...
		labelResultado.setText("No es un triángulo");
	}
}
